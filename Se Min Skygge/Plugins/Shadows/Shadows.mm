...
-(void)initPlugin{
    ...
    [self addProperty:[BoolProperty boolPropertyWithDefaultvalue:NO] named:@"reloadShaders"];
    [self addProperty:[BoolProperty boolPropertyWithDefaultvalue:NO] named:@"reloadImages"];
    
    [self addProperty:[BoolProperty boolPropertyWithDefaultvalue:NO] named:@"debug"];
    [self addProperty:[BoolProperty boolPropertyWithDefaultvalue:YES] named:@"midiMTC"];
